...
def draw_terminal_base():
    ...
    draw.ellipse((MARGIN + 46, MARGIN + 42, MARGIN + 62, MARGIN + 58), fill=RED)
    draw.ellipse((MARGIN + 72, MARGIN + 42, MARGIN + 88, MARGIN + 58), fill='#E9C46A')
    draw.ellipse((MARGIN + 98, MARGIN + 42, MARGIN + 114, MARGIN + 58), fill=GREEN)
    draw.text((MARGIN + 140, MARGIN + 34), 'erdos-problems demo', font=MONO_20, fill=MUTED)
