...
def draw_terminal_base():
    ...
    draw.ellipse((MARGIN + 34, MARGIN + 34, MARGIN + 50, MARGIN + 50), fill=RED)
    draw.ellipse((MARGIN + 60, MARGIN + 34, MARGIN + 76, MARGIN + 50), fill='#E9C46A')
    draw.ellipse((MARGIN + 86, MARGIN + 34, MARGIN + 102, MARGIN + 50), fill=GREEN)
    draw.text((MARGIN + 130, MARGIN + 28), 'erdos-problems demo', font=MONO_20, fill=MUTED)
