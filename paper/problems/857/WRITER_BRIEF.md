# Erdos Problem #857 Writer Brief

Mission:
- turn the current public record for **Sunflower Conjecture** into a paper draft that is readable, citation-safe, and claim-safe
