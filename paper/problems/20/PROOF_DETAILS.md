...
Problem: Erdos Problem #20 — Strong Sunflower Problem
...
- problems/20/EVIDENCE.md
- packs/sunflower/problems/20/ATOMIC_BOARD.md
- packs/sunflower/problems/20/ROUTE_PACKET.yaml
