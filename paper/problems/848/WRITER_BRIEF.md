# Erdos Problem #848 Writer Brief

Mission:
- turn the current public record for **Squarefree ab+1 Extremal Set Problem** into a paper draft that is readable, citation-safe, and claim-safe
